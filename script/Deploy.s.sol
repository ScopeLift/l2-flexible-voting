...
contract Deploy is Script, Constants {
  ...
  function run() public {
    ...
    vm.broadcast();
    L2ERC20 l2Token = new L2ERC20("Scopeapotomus", "SCOPE", wormholeCoreMumbai, address(l1Block));
    ...
    vm.broadcast();
    L1ERC20Bridge bridge = new L1ERC20Bridge(deployedL1Token, wormholeCoreFuji, address(gov));
