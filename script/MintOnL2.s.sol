...
interface IL1ERC20Bridge {
  ...
  function deposit(address account, uint256 amount, address refundAccount, uint16 refundChain) external returns (uint16);
}
...
contract MintOnL2 is Script {
  function run() public {
	...
	address l1Bridge = 0x74975D71A63D0d955160E38bf427dA7f3b030888;
	...
	IERC20Mint erc20 = IERC20Mint(deployedL1Token);
