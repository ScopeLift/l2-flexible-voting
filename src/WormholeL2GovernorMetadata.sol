...
contract WormholeL2GovernorMetadata is L2GovernorMetadata, WormholeReceiver {
  ...
  function receiveWormholeMessages(bytes memory payload, bytes[] memory, bytes32 sourceAddress, uint16 sourceChain, bytes32)
    public
    override
    onlyRelayer isRegisteredSender(sourceChain, sourceAddress)
  {
